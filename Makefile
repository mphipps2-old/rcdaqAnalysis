...
HDRFILES =  include/$(PACKAGE).h include/Configuration.h include/HistoManager.h include/Hit.h include/Processor.h include/TreeManager.h
LINKFILE = include/$(PACKAGE)LinkDef.h

ADDITIONAL_SOURCES = src/Configuration.cxx src/HistoManager.cxx src/Hit.cxx src/Processor.cxx src/TreeManager.cxx
